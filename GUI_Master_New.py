...
#
lbl = tk.Label(root, text="Welcome to Road Damage Detection System", font=('times', 25,' bold underline'), width=70,height=1,bg="black",fg="white")
lbl.place(x=0, y=0)
...
def update_cal(str_T):
    #clear_img()
    result_label = tk.Label(root, text=str_T, width=40, font=("italic", 25), bg='bisque2', fg='black')
...
def openimage():
    ...
    global fn
    print(fn)
    fileName = askopenfilename(initialdir='D:/23 Protech/100% code/Car Damage Detection and Road Pothole/Car and Road damage detection 100% code/Car and Road damage detection 100% code/test', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
...
button2 = tk.Button(frame_alpr, text="Image Processing", command=convert_grey, width=15, height=1, font=('times', 15, ' bold '),bg="white",fg="black")
