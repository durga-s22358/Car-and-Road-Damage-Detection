def main():
    ...
    basepath="E:/New Projects Code/New Topics 2023/vehicle damage detection 100% code/vehicle damage detection 100% code"
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/vehicle_model.h5')
